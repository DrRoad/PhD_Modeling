...
configPATH = "./BM_AOI_CONFIG.sumocfg"
...
PATH_Network_DF_Period_0t00_TEMPLATExlsx = './Network_DF_Period_0t00_TEMPLATE.xlsx'
PATH_BMAOI_edgeCasheFILES = './BMAOI_edgeCasheFILES'
PATH_Network_DF_Period_0t00_DF = './Network_DF_Period_0t00_DF.csv'
...
class Edge():
    ...
    def set(self,edgeID, Bel_Dic_ID):
        ...
        self.net = sumolib.net.readNet('.\Belmount_AOI-V5.net.xml')
...
class Network_Period:
    ...
    def load_n_create_Excel_NetworkFile(SUMO_outPUT_PREFIX, PERIOD_VARRIABLE,steps_TT, display = None, PATH=None):
        ...
        if PATH == None:
            PATH_Network_DF_Period_0t00_TEMPLATExlsx = './Network_DF_Period_0t00_TEMPLATE.xlsx'
            PATH_to_Save_to = "./Network_" + SUMO_outPUT_PREFIX + "_PeriodBook.xlsx"
...
class RunFileInfo:
    ...
    def GetSimulationRunPrefix(display):
        ...
        readfromPATH = './BM_AOI_CONFIG.sumocfg'
